...
// TODO(haosdent): Remove this function after we stop to support `--roles`
// flag in master.
...
Option<Error> validate(const string& role)
{
  ...
  // TODO(haosdent): Pull out this into `stout` and make it satisfies all
  ...
  static string invalidCharacters = "\x09\x0a\x0b\x0c\x0d\x20\x2f\x7f";
  if (role.find_first_of(invalidCharacters) != string::npos) {
    return Error("Role name '" + role + "' is invalid "
