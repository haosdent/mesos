    ...
    const ContentType& responseContentType) const
{
  ...
  RepeatedPtrField<MachineID> machineIds =
    devolve<MachineID, v1::MachineID>(call.start_maintenance().machines());
    ...
    const Option<string>& principal) const
{
  ...
  RepeatedPtrField<MachineID> machineIds =
    devolve<MachineID, v1::MachineID>(call.stop_maintenance().machines());
