    ...
    const Option<NvidiaComponents>& nvidia)
{
  ...
  // Note: For cgroups, we only create `CgroupsIsolatorProcess` once. We use
  // this flag to identify whether `CgroupsIsolatorProcess` have been created or
  // not.
  bool usedCgroups = false;
