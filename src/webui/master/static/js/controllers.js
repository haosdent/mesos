(function() {
  ...
  mesosApp.controller('MainCntl', [
    ...
    var pollState = function() {
      // When current master is not the leader, our request would redirect to
      // the leading master automatically. This would cause CORS error if we
      // send XMLHttpRequest here. To avoid the CORS error, we use JSONP as the
      // workaround here. Please refer to MESOS-5911 for further details.
